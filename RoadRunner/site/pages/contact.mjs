// Contact — two conversations, a next-step rail, and the intake form.
...
function conversations() {
  return `<section class="section">
    <div class="shell">
      ${sectionHead("Two useful conversations", "Scope a pilot or review the MSP white-label model.", "A good first call leaves with enough detail to define access, source scope, deployment model, and the first four weekly runs.")}
      ${rail(2, [
...
function nextSteps() {
  return `<section class="section tight tinted tint-teal">
    <div class="shell">
      ${sectionHead("What happens next", "The next step is specific.", "Bring approximate users, endpoints, tenants, Microsoft licensing, on-prem AD scope, and deployment constraints.")}
      ${rail(4, [
        railCard("01", "30-minute fit call", "Confirm use case, stakeholder role, and whether the pilot runs direct or MSP white-label."),
